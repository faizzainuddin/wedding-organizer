                  ...
                  <table class="table" id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($users as $user) {
                        ...
                        echo "<td><a href='edit_customer.php?id=" . $user['user_id'] . "' class='btn btn-sm btn-outline-warning'>Edit</a></td>";
                        echo "<td><a href='delete_customer.php?id=" . $user['user_id'] . "' class='btn btn-sm btn-outline-danger'>Delete</a></td>";
                        echo "</tr>";
                      }
                      ?>
                    </tbody>
